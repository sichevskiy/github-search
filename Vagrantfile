...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "recruiting" do |recruiting|
	...
	recruiting.vm.box_url = "http://cloud-images.ubuntu.com/vagrant/precise/current/precise-server-cloudimg-amd64-vagrant-disk1.box"
        ...
        recruiting.vm.synced_folder "c:/github-user-search", "/var/www/github-user-search", owner: "www-data", group: "www-data", :mount_options => ["dmode=777","fmode=666"]
...
SCRIPT
        ...
        config.vm.provision "shell" do |sh|
                sh.inline = "ansible-playbook /var/www/github-user-search/build/ansible/dev.yml --inventory-file=/var/www/github-user-search/build/ansible/dev --connection=local"
        end
